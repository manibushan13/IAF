...
public class Profile_SkillsDP extends DataInjection {
	
Logger logger = Logger.getLogger(Profile_SkillsDP.class.getName());
	...
	String sheetName;
	 ...
	 public Profile_SkillsDP(final String orPath, final String tdPath, final String configPath) 
	 {
		 
		 super(orPath, tdPath, configPath);
		 this.sheetName = "Skills";
	 ...
	 public static Object[][] createDP()
	 {
		...
		return new Object[][]{{new  Profile_SkillsDP(orPath, tdPath, configPath)}};
