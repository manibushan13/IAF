...
public class SkillsDP extends DataInjection{
	
	
Logger logger = Logger.getLogger(SkillsDP.class.getName());
	...
	String sheetName;
	 ...
	 public SkillsDP(final String orPath, final String tdPath, final String configPath) 
	 {
		 
		 super(orPath, tdPath, configPath);
		 this.sheetName = "Profile_Skills";
	 ...
	 public static Object[][] createDP()
	 {
		...
		return new Object[][]{{new  SkillsDP(orPath, tdPath, configPath)}};
